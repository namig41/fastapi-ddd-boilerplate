...
config.set_section_option(section, 'DB_PROVIDER', settings.DATABASE_PROVIDER)
config.set_section_option(section, 'DB_USER', settings.DATABASE_USER)
config.set_section_option(section, 'DB_PASSWORD', settings.DATABASE_PASSWORD)
...
config.set_section_option(section, 'DB_SCHEMA', settings.DATABASE_SCHEME)
